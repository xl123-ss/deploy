  ...
  ;(r.prototype.cache = n),
    ...
    (r.prototype.use = function (r, o, c, s) {
      ...
      function f() {
        c.push(layui[h]),
          r.length > 1
            ...
            : 'function' == typeof o &&
              (function () {
                return layui.jquery && 'function' == typeof layui.jquery && 'define' !== s
      ...
      if (
        ...
        return f(), y
      var g =
        (l[h] ? d + 'modules/' : /^\{\/\}/.test(y.modules[h]) ? '' : n.base || '') +
        (y.modules[h] || h) +
        '.js'
      if (
        ((g = g.replace(/^\{\/\}/, '')),
        ...
        !(function S() {
          return ++m > (1e3 * n.timeout) / 4
            ? i(h + ' is not a valid module', 'error')
            : void ('string' == typeof n.modules[h] && n.status[h] ? f() : setTimeout(S, 4))
        })()
      else {
        ...
        ;(b.async = !0),
          ...
          v.appendChild(b),
          !b.attachEvent ||
          (b.attachEvent.toString && b.attachEvent.toString().indexOf('[native code') < 0) ||
          u
            ? b.addEventListener(
                'load',
                function (t) {
              ...
              return ++f > (1e3 * n.timeout) / u
                ...
                : void (1989 === parseInt(a.getStyle(l, 'width'))
                    ? (o === p && l.removeAttribute('lay-status'),
                      l.getAttribute('lay-status') === p ? setTimeout(y, u) : r())
      ...
      function (t, e, r, o) {
        ...
        return r === c
          ...
          : (layui.each(n.event[l], function (t, e) {
              return '{*}' === s
                ? void layui.each(e, p)
                : ('' === t && layui.each(e, p), void (s && t === s && layui.each(e, p)))
            }),
            i)
      }),
...
!(function (t) {
  ...
  var e = 'lay',
    ...
    o = function (t) {
      for (
        var e = 0,
          r = 'object' == typeof t ? [t] : ((this.selector = t), n.querySelectorAll(t || null));
        e < r.length;
        e++
      )
        this.push(r[e])
  ...
  ;(o.prototype = []),
    ...
    (r.ie = (function () {
      ...
      return (
        !!(t.ActiveXObject || 'ActiveXObject' in t) && ((e.match(/msie\s(\d+)/) || [])[1] || '11')
      )
    })()),
    (r.layui = layui || {}),
      ...
      if (o) {
        ...
        'center' === i.align
          ...
          p + a + l > s() &&
            (c.top > a + l
              ? (p = c.top - a - 2 * l)
              : 'right' === i.clickType && ((p = s() - a - 2 * l), p < 0 && (p = 0)))
        var y = i.position
        if (
    ...
    (t.pt.parse = function (e, t) {
      ...
      ;(e = e
        ...
        .replace(c.query(), function (e) {
          return (
            (e = e.replace(a, '').replace(l, '')), '";' + e.replace(/\\(.)/g, '$1') + ';view+="'
          )
        })
  ...
  ;(r.formatArr = function (e) {
    ...
    (D.prototype.init = function () {
      ...
      ;(a.elem = lay(a.elem)),
        ...
        a.elem[0] &&
          ((t.rangeStr = a.range ? ('string' == typeof a.range ? a.range : '-') : ''),
          'array' === layui._typeof(a.range) && (t.rangeElem = [lay(a.range[0]), lay(a.range[1])]),
          i[a.type] ||
            (e.console &&
              console.error &&
              console.error("laydate type error:'" + a.type + "' is not supported"),
            (a.type = 'date')),
          ...
          lay.each(t.format, function (e, a) {
            var n = new RegExp(w).test(a)
              ? '\\d{' +
                (function () {
                  return new RegExp(w).test(t.format[0 === e ? e + 1 : e - 1] || '')
                    ? /^yyyy|y$/.test(a)
                      ? 4
                      : a.length
                    : /^yyyy$/.test(a)
          ...
          (t.EXP_IF = new RegExp(
            '^' + (a.range ? t.EXP_IF + '\\s\\' + t.rangeStr + '\\s' + t.EXP_IF : t.EXP_IF) + '$'
          )),
          (t.EXP_SPLIT = new RegExp('^' + t.EXP_SPLIT + '$', '')),
          t.isInput(a.elem[0]) || ('focus' === a.trigger && (a.trigger = 'click')),
          a.elem.attr('lay-key') ||
            (a.elem.attr('lay-key', t.index), a.eventElem.attr('lay-key', t.index)),
          (a.mark = lay.extend(
            {},
      ...
      if (
        ...
        lay.each(new Array(2), function (e) {
          ...
          lay.each(i, function (e, a) {
            ...
            l.appendChild(r),
            (o[e] = lay.elem('div', { class: 'layui-laydate-main laydate-main-list-' + e })),
            o[e].appendChild(t),
            o[e].appendChild(l),
            s.push(i),
            y.push(l),
        ...
        lay(m).html(
          (function () {
            ...
            return (
              'datetime' === a.type &&
                e.push('<span lay-type="datetime" class="' + v + '">' + n.timeTips + '</span>'),
              (a.range || 'datetime' !== a.type) &&
                e.push('<span class="' + T + '" title="' + n.preview + '"></span>'),
              lay.each(a.btns, function (e, l) {
                var r = n.tools[l] || 'btn'
                ;(a.range && 'now' === l) ||
                  (i && 'clear' === l && (r = 'cn' === a.lang ? '\u91cd\u7f6e' : 'Reset'),
                  t.push(
    ...
    (D.prototype.checkDate = function (e) {
            ...
            lay.each(n.format, function (o, s) {
              ...
              t[o].length < s.length && (a = !0),
                /yyyy|y/.test(s)
                  ...
                  : /HH|H/.test(s)
                  ? (y < 1 && ((y = 0), (a = !0)), (e.hours = y), i.range && (n[r[l]].hours = y))
                  : /mm|m/.test(s)
                  ? (y < 1 && ((y = 0), (a = !0)),
                    (e.minutes = y),
      ...
      u(),
        'string' == typeof y && y
          ? n.EXP_IF.test(y)
            ...
            : (n.hint(
                r.formatError[0] +
                  (i.range ? i.format + ' ' + n.rangeStr + ' ' + i.format : i.format) +
                  r.formatError[1]
              ),
              (a = !0))
      ...
      return (
        (h(o) > h(i.max) || h(o) < h(i.min)) && (o = i.dateTime = lay.extend({}, i.min)),
        i.range &&
        ...
        lay.each(f, function (e, t) {
          ...
          ;(t = lay(t)),
            ...
            e < n
              ...
              : ((l = e - r - n), t.addClass('laydate-day-next'), (a = o.getAsYM(d.year, d.month))),
            a[1]++,
            (a[2] = l + 1),
          ...
          lay.each(new Array(15), function (e) {
            ...
            M == D[0] && lay(i).addClass(y),
              ...
              M < a.firstDate.year
                ...
                : M >= a.firstDate.year && ((l.month = n.max.month), (l.date = n.max.date)),
              a.limit(lay(i), l, t),
              M++
          }),
          lay(m[f ? 0 : 1])
    ...
    (r.getThis = function (e) {
      ...
      return (
        !t &&
          ...
          layui
            .hint()
            .error(e ? o + " instance with ID '" + e + "' not found" : 'ID argument required'),
        t
      )
    }),
    (n.run = function (a) {
...
!(function (e, t) {
  ...
  var ve = (function (e) {
    ...
    function a(e, t) {
      var n = t && e,
        r =
          n && 1 === e.nodeType && 1 === t.nodeType && (~t.sourceIndex || V) - (~e.sourceIndex || V)
      if (r) return r
                ...
                return ++u > 1e4 / n
                  ...
                  : void (1989 === parseInt(o.getStyle(a, 'width'))
                      ? (t === c && a.removeAttribute('lay-status'),
                        a.getAttribute('lay-status') === c ? setTimeout(d, n) : i())
  ...
  var o = '.layui-nav',
    ...
    b = {
      tabClick: function (t, a, s, o) {
        ...
        d ||
          f ||
          (r.addClass(l).siblings().removeClass(l), u.eq(a).addClass(n).siblings().removeClass(n)),
          ...
          var t = 200,
            ...
            C = function (l, o, r) {
              ...
              if (o.hasClass(u)) {
                ...
                h.addClass(p),
                  h.hasClass(d) && h.css({ left: -(h.outerWidth() - c.width()) / 2 }),
                  h[0]
                    ? l.css({
    ...
    (p.prototype.upload = function (e, i) {
      var n,
        ...
        y = function () {
          if (
            !(
              (('choose' === i || l.auto) && (l.choose && l.choose(g), 'choose' === i)) ||
...
layui.define(['jquery', 'laytpl', 'lay'], function (e) {
  ...
  ;(k.prototype.config = {
    ...
    (d.getThis = function (e) {
      var i = d.that[e]
      return (
        i || t.error(e ? r + " instance with ID '" + e + "' not found" : 'ID argument required'), i
      )
    }),
    (d.spread = function (e) {
    ...
    !(function () {
      ...
      n.on('mouseenter', a, function (n) {
        ...
        if (a[0]) {
          ...
          l.right > e.width() &&
            (a.addClass(C), (l = a[0].getBoundingClientRect()), l.left < 0 && a.removeClass(C)),
      ...
      var e = this,
        ...
        o = i(
          [
            ...
            '<span ' +
              ('rgb' == r.format && r.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : '') +
              '>',
            '<span class="layui-colorpicker-trigger-span" ',
            'lay-type="' + ('rgb' == r.format ? (r.alpha ? 'rgba' : 'torgb') : '') + '" ',
            'style="' +
              (function () {
                var e = ''
                return r.color
                  ? ((e = r.color),
                    (r.color.match(/[0-9]{1,3}/g) || []).length > 3 &&
                      ((r.alpha && 'rgb' == r.format) || (e = '#' + w(P(D(r.color))))),
                    'background: ' + e)
                  : e
              })() +
              '">',
            '<i class="layui-icon layui-colorpicker-trigger-i ' + (r.color ? d : u) + '"></i>',
            '</span>',
            '</span>',
            '</div>'
          ].join('')
            ...
            var e,
              ...
              v = function (i, l) {
                ;(t(i.target).parent().hasClass(n) && !l) ||
                  (t('.' + a).removeClass(a + 'ed ' + a + 'up'), e && u && e.val(u)),
                  (e = null)
              },
              y = function (i, d, f) {
                var y,
                            ...
                            l[0]
                              ? ((y = r[t]()),
                                (n[0] && !n.hasClass(c)) || !y[0]
                                  ? (n.addClass(o).siblings().removeClass(o), void T())
                                  : i(t, y))
                              : (y = null)
                          )
                        }
                ...
                [
                  ...
                  '<div>' +
                    (function () {
                      var e = l.title || ''
                      return (
                        'string' == typeof r.next().attr('lay-radio') && (e = r.next().html()), e
                      )
                    })() +
                    '</div>',
                  '</div>'
...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function (e) {
  ...
  var t = layui.$,
    ...
    u = function (e) {
      ...
      return (
        t ||
          r.error(e ? "The table instance with ID '" + e + "' not found" : 'ID argument required'),
        t || null
      )
    },
    y = function (e, a, l, n) {
  ...
  ;(H.prototype.config = {
    ...
    (H.prototype.render = function () {
      ...
      a.height &&
        ...
        ((e.fullHeightGap = a.height.split('-')[1]), (a.height = F.height() - e.fullHeightGap)),
        e.setInit()
      var l = a.elem,
        n = l.next('.' + m),
            ...
            return c
              ? void (
                  ...
                  (e
                    ...
                    : ((d = c.width || 0),
                      /\d+%$/.test(d)
                        ? ((d = Math.floor((parseFloat(d) / 100) * o)), d < s && (d = s))
                        : d || ((c.width = d = 0), a++)),
                  c.hide && (d = 0),
                  (n += d))
                )
          ...
          var d = c.field || e,
            s = (function () {
              var e,
                ...
                n = {}
              return (
                (n[d] = i), (e = c.totalRow ? y.call(l, c, i, n) || t : t), a ? a[c.field] || e : e
              )
            })(),
            u = [
              '<td data-field="' +
                ...
                (function () {
                  var e = []
                  return (
                    c.hide && e.push(p), c.field || e.push('layui-table-col-special'), e.join(' ')
                  )
                })() +
                '">',
              '<div class="layui-table-cell laytable-cell-' +
    ...
    (H.prototype.loading = function (e) {
      ...
      a.loading &&
        (e
          ? (i.layInit && i.layInit.remove(), delete i.layInit, i.layBox.find(x).remove())
          : ((i.layInit = t(
              [
    ...
    (H.prototype.fullSize = function () {
      var e,
        ...
        a = i.height
      t.fullHeightGap &&
        ((a = F.height() - t.fullHeightGap), a < 135 && (a = 135), t.elem.css('height', a)),
        a &&
      ...
      i.elem.on('click', 'input[name="layTableCheckbox"]+', function () {
        ...
        i.elem.on('click', 'input[lay-type="layTableRadio"]+', function () {
          ...
          layui.each(n, function (e, t) {
            ...
            layui.event.call(this, h, 'radio(' + f + ')', v.call(this, { checked: l }))
        }),
        i.layBody
      ...
      i.layBody
        .on('change', '.' + R, function () {
          var e = t(this),
            ...
            o = d.cache[i.key][n]
          ;(o[l] = a),
            layui.event.call(this, h, 'edit(' + f + ')', v.call(this, { value: a, field: l }))
        })
        .on('blur', '.' + R, function () {
          var e,
            a = t(this),
    ...
    (v.prototype.render = function () {
      ...
      ;(l.elem = a(l.elem)),
        ...
        parseInt(l.value) !== l.value &&
          (l.half ||
            (l.value =
              Math.ceil(l.value) - l.value < 0.5 ? Math.ceil(l.value) : Math.floor(l.value)))
      for (
        var n = '<ul class="layui-rate" ' + (l.readonly ? 'readonly' : '') + '>', s = 1;
        s <= l.length;
        s++
      ) {
        var r =
        ...
        layui.each(l.reverse(), function (l, i) {
          ...
          ;(t.attr('lay-encode') || a.encode) &&
            (c = c
              ...
              .replace(/"/g, '&quot;')),
            t.html(
              '<ol class="layui-code-ol"><li>' + c.replace(/[\r\t\n]+/g, '</li><li>') + '</li></ol>'
            ),
